    ...
    transition-all duration-300 hover:scale-105">
          ...
          <div>
            ...
            <div className="mb-10 mt-10 text-center md:text-left">
              ...
              <p className="mt-4 text-base-content/60 max-w-3xl text-sm md:text-lg">
                Manage and monitor all the study rooms you’ve added.
                Update room details, pricing, and availability from one place.
              </p>
            </div>
          ...
          border-none">
                ...
                transition`}
                      ...
                      <div className="card-actions justify-end mt-5">
                        ...
                        <Link href={`/`} className='btn w-full bg-indigo-500 hover:bg-indigo-600 
              dark:bg-indigo-600 dark:hover:bg-indigo-500 
